...
<div class="navbar navbar-inverse">
    ...
    <div class="navbar-collapse collapse navbar-inverse-collapse">
        <ul class="nav navbar-nav">
            ...
            <li><a href="WEB-INF/jsp/connections.jsp">Connections</a></li>
            <li><a href="#">Jobs</a></li>
                            ...
                            <div class="row">
                                <div ng-repeat="position in profile.positions">
                                    <div class="col-xs-6">
                                        ...
                                        <br/>
                                        <h7>{{position.startDate.year}}-{{position.startDate.month}} &nbsp;&nbsp; <span
                                                ng-if="position.current == true">Current</span> <span
            ...
            <div class="row">
                <div class="col-md-12" align="justify">
                    <div class="panel panel-default">
                        ...
                        <a style="margin-left:92% " href="WEB-INF/jsp/connections.jsp">see more</a>
                    </div>
                </div>
            </div>
        </div>

            ...
            function M(a, b, c) {
                ...
                if (g) {
                    ...
                    if (U(k)) {
                        ...
                        return{node: g, event: b, className: c, isClassBased: h, isSetClassOperation: p, before: function (a) {
                            t = a;
                            e(n, v, function () {
                                t =
                                    q;
            ...
            ["$window", "$sniffer", "$timeout", "$$animateReflow", function (g, h, z, J) {
                ...
                function I(a, b) {
                    ...
                    if (!c) {
                        ...
                        c = {total: 0, transitionPropertyStyle: m, transitionDurationStyle: $, transitionDelayStyle: h, transitionDelay: d, transitionDuration: e, animationDelayStyle: Z, animationDelay: k, animationDuration: f};
                        b && (s[b] = c)
                    }
                    return c
                }
                ...
                function V(a, b, c, d) {
                    ...
                    b.data(u, {running: m.running || 0, itemIndex: k,
